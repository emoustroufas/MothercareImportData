            ...
            if (typeof(T) == typeof(ItemMasterRecord))
            {
                ...
                foreach (var row in rows)
                {
                    ...
                    if (row.Columns.Any())
                    {
                        ...
                        item.Department = Convert.ToInt32(FileUtil.InBounds(11, row.Columns) ? (row.Columns.Count > 11 ? (row.Columns[11] != "" ? row.Columns[11] : "0") : "0") : "0");
                        item.Subdept = Convert.ToInt32(FileUtil.InBounds(12, row.Columns) ? (row.Columns.Count > 12 ? (row.Columns[12] != "" ? row.Columns[12] : "0") : "0") : "0");
                        item.Class = Convert.ToInt32(FileUtil.InBounds(13, row.Columns) ? (row.Columns.Count > 13 ? (row.Columns[13] != "" ? row.Columns[13] : "0") : "0") : "0");
                        item.Year = Convert.ToInt32(FileUtil.InBounds(14, row.Columns) ? (row.Columns.Count > 14 ? (row.Columns[14] != "" ? row.Columns[14] : "0") : "0") : "0");
